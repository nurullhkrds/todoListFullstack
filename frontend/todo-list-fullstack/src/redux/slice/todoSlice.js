...
export const todoSlice = createSlice({
  ...
  extraReducers: {
    ...
    //filter date
    [filterDate.pending]: (state, action) => {
      state.todosAllStatus = "loading";
    },
    ...
    [filterDate.rejected]: (state, action) => {
      ...
      //filter date and priotry
    [filterDateAndPriotry.pending]: (state, action) => {
      state.todosAllStatus = "loading";
    },
    [filterDateAndPriotry.fulfilled]: (state, action) => {
      state.todosAll = action.payload;
      state.todosAllFiltre=action.payload
      state.todosAllStatus = "succes";
    },
    [filterDateAndPriotry.rejected]: (state, action) => {
      state.todosAllStatus = "failed";
      state.todosAllError = action.error.message;
    },
    ...
    //completed
    [completedService.pending]: (state, action) => {
      state.todosAllStatus = "loading";
    },
    [completedService.fulfilled]: (state, action) => {
    ...
    [completedService.rejected]: (state, action) => {
      state.todosAllStatus = "failed";
      state.todosAllError = action.error.message;
    },
